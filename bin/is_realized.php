...
use TotalCRM\OzonApi\Service\V1\CategoriesService;
use TotalCRM\OzonApi\Service\V1\ProductService as V1ProductService;
use TotalCRM\OzonApi\Service\V2\Posting\CrossborderService;
use TotalCRM\OzonApi\Service\V2\Posting\FbsService;
use TotalCRM\OzonApi\Service\V2\ProductService as V2ProductService;
use TotalCRM\OzonApi\Service\V2\ReturnsService as V2ReturnsService;
...
{
    $prefix = 'TotalCRM\\OzonApi\\Service\\';
